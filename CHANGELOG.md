...
- feat: add sessionToken handling to support Grafana Assume Role in [#628](https://github.com/grafana/timestream-datasource/pull/628)
...
- chore: update renovate config to use data-sources base preset in [#619](https://github.com/grafana/timestream-datasource/pull/619)
...
- chore(deps): update dependency @grafana/aws-sdk to v0.10.1 in [#597](https://github.com/grafana/timestream-datasource/pull/597)
- chore(deps): update dependency @grafana/plugin-e2e to v3.2.2 in [#596](https://github.com/grafana/timestream-datasource/pull/596)
- chore(deps): update dependency @grafana/aws-sdk to v0.10.0 in [#593](https://github.com/grafana/timestream-datasource/pull/593)
- chore(deps): update dependency @babel/core to ^7.29.0 in [#586](https://github.com/grafana/timestream-datasource/pull/586)
- chore(deps): update dependency semver to ^7.7.3 in [#590](https://github.com/grafana/timestream-datasource/pull/590)
- chore(deps): update dependency @playwright/test to v1.58.1 in [#584](https://github.com/grafana/timestream-datasource/pull/584)
- fix(deps): update module github.com/grafana/grafana-plugin-sdk-go to v0.287.0 in [#589](https://github.com/grafana/timestream-datasource/pull/589)
- chore(deps): update actions/checkout digest to de0fac2 in [#585](https://github.com/grafana/timestream-datasource/pull/585)
- chore(deps): update dependency @playwright/test to v1.58.0 in [#578](https://github.com/grafana/timestream-datasource/pull/578)
- chore(deps): update dependency @grafana/plugin-e2e to v3.2.1 in [#583](https://github.com/grafana/timestream-datasource/pull/583)
- chore(deps): update dependency @grafana/aws-sdk to v0.9.0 in [#582](https://github.com/grafana/timestream-datasource/pull/582)
- fix(deps): update module github.com/grafana/grafana-aws-sdk to v1.4.3 in [#581](https://github.com/grafana/timestream-datasource/pull/581)
- chore(deps): update dependency sass to v1.97.3 in [#577](https://github.com/grafana/timestream-datasource/pull/577)
- chore(deps): update dependency @grafana/plugin-e2e to v3.2.0 in [#580](https://github.com/grafana/timestream-datasource/pull/580)
- chore(deps): update dependency @testing-library/react to v16.3.2 in [#573](https://github.com/grafana/timestream-datasource/pull/573)
- chore(deps): update grafana monorepo to v12.3.2 in [#579](https://github.com/grafana/timestream-datasource/pull/579)
- fix(deps): update module github.com/grafana/grafana-plugin-sdk-go to v0.286.0 in [#571](https://github.com/grafana/timestream-datasource/pull/571)
- chore(deps): update grafana/plugin-ci-workflows/ci-cd-workflows action to v6.1.0 in [#575](https://github.com/grafana/timestream-datasource/pull/575)
- chore(deps): update dependency @types/node to v24.10.9 in [#576](https://github.com/grafana/timestream-datasource/pull/576)
- chore(deps): update node.js to v24 in [#570](https://github.com/grafana/timestream-datasource/pull/570)
- chore(deps): update actions/checkout action to v6 in [#562](https://github.com/grafana/timestream-datasource/pull/562)
- chore(deps): update dependency @types/node to ^22.19.7 in [#534](https://github.com/grafana/timestream-datasource/pull/534)
- chore(deps): update dependency glob to v13 in [#574](https://github.com/grafana/timestream-datasource/pull/574)
- chore(deps): update dependency eslint-plugin-jsdoc to v62 in [#565](https://github.com/grafana/timestream-datasource/pull/565)
- chore(deps): update dependency prettier to ^3.8.0 in [#569](https://github.com/grafana/timestream-datasource/pull/569)
- chore(deps): update dependency swc-loader to ^0.2.6 in [#567](https://github.com/grafana/timestream-datasource/pull/567)
- fix(deps): update go patch updates in [#568](https://github.com/grafana/timestream-datasource/pull/568)
- fix(deps): update golang.org/x/exp digest to 716be56 in [#517](https://github.com/grafana/timestream-datasource/pull/517)
- chore(deps): update dependency react-router-dom to v6.30.3 in [#566](https://github.com/grafana/timestream-datasource/pull/566)
- chore(deps): update dependency glob to v11.1.0 [security] in [#551](https://github.com/grafana/timestream-datasource/pull/551)
- chore(deps): update dependency @playwright/test to v1.57.0 in [#542](https://github.com/grafana/timestream-datasource/pull/542)
- chore(deps): update dependency @grafana/eslint-config to v9 in [#563](https://github.com/grafana/timestream-datasource/pull/563)
- fix(deps): update aws-sdk-go-v2 monorepo in [#561](https://github.com/grafana/timestream-datasource/pull/561)
- chore(deps): update yarn to v4.12.0 in [#560](https://github.com/grafana/timestream-datasource/pull/560)
- chore(deps): update testing-library monorepo in [#559](https://github.com/grafana/timestream-datasource/pull/559)
- chore(deps): update jest monorepo to ^30.2.0 in [#558](https://github.com/grafana/timestream-datasource/pull/558)
- chore(deps): update grafana monorepo to v12.3.1 in [#557](https://github.com/grafana/timestream-datasource/pull/557)
- chore(deps): update dependency webpack to ^5.104.1 in [#556](https://github.com/grafana/timestream-datasource/pull/556)
- chore(deps): update dependency sass to v1.97.2 in [#554](https://github.com/grafana/timestream-datasource/pull/554)
- chore(deps): update dependency @grafana/aws-sdk to v0.8.3 in [#541](https://github.com/grafana/timestream-datasource/pull/541)
- chore(deps): update dependency typescript to v5.9.3 in [#555](https://github.com/grafana/timestream-datasource/pull/555)
- chore(deps): update dependency cspell to ^9.4.0 in [#552](https://github.com/grafana/timestream-datasource/pull/552)
- chore(deps): update dependency semver to ^7.7.2 in [#519](https://github.com/grafana/timestream-datasource/pull/519)
- chore(deps): update dependency @babel/core to ^7.28.5 in [#540](https://github.com/grafana/timestream-datasource/pull/540)
- chore(deps): update dependency sass-loader to v16.0.6 in [#539](https://github.com/grafana/timestream-datasource/pull/539)
- chore(deps): update dependency react-router-dom to v6.30.3 in [#538](https://github.com/grafana/timestream-datasource/pull/538)
- chore(deps): update dependency @types/testing-library__jest-dom to v5.14.9 in [#518](https://github.com/grafana/timestream-datasource/pull/518)
- Update to use self-hosted renovate and remove dependabot in [#536](https://github.com/grafana/timestream-datasource/pull/536)
- use prod environment for cd workflow in [#537](https://github.com/grafana/timestream-datasource/pull/537)
- chore(deps): update module golang.org/x/crypto to v0.45.0 [security] in [#527](https://github.com/grafana/timestream-datasource/pull/527)
- chore(deps): update dependency glob to v11.1.0 [security] in [#528](https://github.com/grafana/timestream-datasource/pull/528)
- Bump grafana-aws-sdk to 1.4.2 in [#535](https://github.com/grafana/timestream-datasource/pull/535)
- update ci-cd workflows to v4.3.0 in [#533](https://github.com/grafana/timestream-datasource/pull/533)
- revert skip dev image for e2e tests in [#532](https://github.com/grafana/timestream-datasource/pull/532)
- skip dev images for e2e tests in [#531](https://github.com/grafana/timestream-datasource/pull/531)
