...
test('should successfully create an alert rule', async ({
  ...
  await page.keyboard.insertText(
    `select region, cell, silo, instance_name, avg(measure_value::double) from $__database.$__table where time between from_milliseconds(1615395600000) and from_milliseconds(1615395900000) and measure_value::double > 1 group by region, cell, silo, instance_name limit 10`
  );
