...
func NewGoogleClient(ctx context.Context, auth *models.TimestreamConfig) (*GoogleClient, error) {
...
func createSheetsService(ctx context.Context, auth *models.TimestreamConfig) (*sheets.Service, error) {
...
func createDriveService(ctx context.Context, auth *models.TimestreamConfig) (*drive.Service, error) {
	if len(auth.AuthType) == 0 {
		return nil, fmt.Errorf("missing AuthType setting")
	}
