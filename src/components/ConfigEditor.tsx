      ...
      <div className="gf-form-group">
        <div className="gf-form">
          ...
          <Select
            className="width-30"
            value={
              googleAuthTypes.find(x => x.value === jsonData.authType) ||
              googleAuthTypes[0]
            }
        ...
        {jsonData.authType === GoogleAuthType.JWT && (
          <JWTConfig
            isConfigured={
              (secureJsonFields && !!secureJsonFields.jwt) as boolean
            }
            onChange={jwt => {
              onOptionsChange({
                ...options,
          ...
          {jsonData.authType === GoogleAuthType.JWT ? (
            <>
              ...
              <ol style={{ listStylePosition: "inside" }}>
                ...
                <li>
                  Click <strong>Create Credentials</strong> then click{" "}
                  <strong>Service account</strong>.
                </li>

                <li>
                  On the Create service account page, enter the Service account
                  details.
                </li>
                <li>
                  Click <strong>Create</strong>. A JSON key file is created and
                ...
                <li>
                  Open the{" "}
                  <a href="https://console.cloud.google.com/apis/library/drive.googleapis.com?q=drive">
                    Google Drive
                  </a>{" "}
                  in API Library and enable access for your account. Access to
                  the Google Drive API is used to list all spreadsheets that you
                  have access to.
                </li>
                <li>
                  Drag the file to the dotted zone below. The file contents are
            ...
            <>
              ...
              <ol style={{ listStylePosition: "inside" }}>
                ...
                <li>
                  Click <strong>Create Credentials</strong> and then click{" "}
                  <strong>API key</strong>.
                </li>
                <li>
                  Copy the key and paste it in the API Key field above. The file
                  contents are encrypted and saved in the Grafana database.
                </li>
              </ol>
            </>
          )}
