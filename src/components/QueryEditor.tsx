...
export function getGoogleSheetRangeInfoFromURL(
  url: string
): Partial<SheetsQuery> {
      ...
      <>
        ...
        <div className="gf-form-inline">
          <FormLabel
            ...
            tooltip={
              <p>
                A string like <code>Sheet1!A1:B2</code>, that refers to a group
                of cells in the spreadsheet, and is typically used in
                formulas.Named ranges are also supported. When a named range
                conflicts with a sheet's name, the named range is preferred.
              </p>
            }
          >
            Range
        ...
        <div className="gf-form-inline">
          ...
          <Segment
            value={{
              label: `${query.cacheDurationSeconds}s`,
              value: query.cacheDurationSeconds
            }}
